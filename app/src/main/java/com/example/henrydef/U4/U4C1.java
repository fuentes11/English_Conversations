package com.example.henrydef.U4;
...
import com.example.henrydef.U3.U3C3;

import java.io.IOException;

public class U4C1 extends AppCompatActivity {

    private MediaRecorder grabacion, grabacion2, grabacion3, grabacion4, grabacion5, grabacion6, grabacion7, grabacion8, grabacion9, grabacion10, grabacion11, grabacion12;

    MediaPlayer mp1, mp2, mp3, mp4, mp5, mp6, mp7, mp8, mp9, mp10, mp11, mp12;

    Button b1, b2, b3, b4, b5, b6, b7, b8, b9, b10, b11, b12, next,back,home;

    private String archivoSalida = null, archivoSalida2 = null, archivoSalida3 = null, archivoSalida4 = null, archivoSalida5 = null, archivoSalida6 = null, archivoSalida7 = null, archivoSalida8 = null, archivoSalida9 = null, archivoSalida10 = null, archivoSalida11 = null, archivoSalida12 = null;

    private Button btn_recorder, btn_recorder2, btn_recorder3, btn_recorder4, btn_recorder5, btn_recorder6, btn_recorder7, btn_recorder8, btn_recorder9, btn_recorder10, btn_recorder11, btn_recorder12;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_u4_c1);

        b1 = (Button) findViewById(R.id.btn_repoU4C11);
        b2 = (Button) findViewById(R.id.btn_repoU4C12);
        b3 = (Button) findViewById(R.id.btn_repoU4C13);
        b4 = (Button) findViewById(R.id.btn_repoU4C14);
        b5 = (Button) findViewById(R.id.btn_repoU4C15);
        b6 = (Button) findViewById(R.id.btn_repoU4C16);
        b7 = (Button) findViewById(R.id.btn_repoU4C17);
        b8 = (Button) findViewById(R.id.btn_repoU4C18);
        b9 = (Button) findViewById(R.id.btn_repoU4C19);
        b10 = (Button) findViewById(R.id.btn_repoU4C110);
        b11 = (Button) findViewById(R.id.btn_repoU4C111);
        b12 = (Button) findViewById(R.id.btn_repoU4C112);
        next = (Button) findViewById(R.id.nextconver1);

        mp1 = MediaPlayer.create(this, R.raw.u411);
        mp2 = MediaPlayer.create(this, R.raw.u412);
        mp3 = MediaPlayer.create(this, R.raw.u413);
        mp4 = MediaPlayer.create(this, R.raw.u414);
        mp5 = MediaPlayer.create(this, R.raw.u415);
        mp6 = MediaPlayer.create(this, R.raw.u416);
        mp7 = MediaPlayer.create(this, R.raw.u417);
        mp8 = MediaPlayer.create(this, R.raw.u418);
        mp9 = MediaPlayer.create(this, R.raw.u419);
        mp10 = MediaPlayer.create(this, R.raw.u4110);
        mp11 = MediaPlayer.create(this, R.raw.u4111);
        mp12 = MediaPlayer.create(this, R.raw.u4112);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), U3C3.class));
                finish();
            }
        });
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(U4C1.this, U4C2.class);
        ...
        btn_recorder =(Button) findViewById(R.id.btn_recU4C11);

        btn_recorder2 =(Button) findViewById(R.id.btn_recU4C12);

        btn_recorder3 =(Button) findViewById(R.id.btn_recU4C13);

        btn_recorder4 =(Button) findViewById(R.id.btn_recU4C14);

        btn_recorder5 =(Button) findViewById(R.id.btn_recU4C15);

        btn_recorder6 =(Button) findViewById(R.id.btn_recU4C16);

        btn_recorder7 =(Button) findViewById(R.id.btn_recU4C17);

        btn_recorder8 =(Button) findViewById(R.id.btn_recU4C18);

        btn_recorder9 =(Button) findViewById(R.id.btn_recU4C19);

        btn_recorder10 =(Button) findViewById(R.id.btn_recU4C110);

        btn_recorder11 =(Button) findViewById(R.id.btn_recU4C111);

        btn_recorder12 =(Button) findViewById(R.id.btn_recU4C112);
        ...
        {
            ActivityCompat.requestPermissions(U4C1.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.RECORD_AUDIO}, 1000);
        }
    }

    public void RecorderU4C11 (View view){
        if (grabacion == null) {
            archivoSalida = getExternalFilesDir(null).getAbsolutePath() + "/GrabacionU4C11.mp3";
    ...
    public void reproducirU4C11 (View view){
    ...
    public void RecorderU4C12 (View view){
        if (grabacion2 == null) {
            archivoSalida2 = getExternalFilesDir(null).getAbsolutePath() + "/GrabacionU4C12.mp3";
    ...
    public void reproducirU4C12 (View view){
    ...
    public void RecorderU4C13 (View view){
        if (grabacion3 == null) {
            archivoSalida3 = getExternalFilesDir(null).getAbsolutePath() + "/GrabacionU4C13.mp3";
    ...
    public void reproducirU4C13 (View view){
    ...
    public void RecorderU4C14 (View view){
        if (grabacion4 == null) {
            archivoSalida4 = getExternalFilesDir(null).getAbsolutePath() + "/GrabacionU4C14.mp3";
    ...
    public void reproducirU4C14 (View view){
    ...
    public void RecorderU4C15 (View view){
        if (grabacion5 == null) {
            archivoSalida5 = getExternalFilesDir(null).getAbsolutePath() + "/GrabacionU4C15.mp3";
    ...
    public void reproducirU4C15 (View view){
    ...
    public void RecorderU4C16 (View view){
        if (grabacion6 == null) {
            archivoSalida6 = getExternalFilesDir(null).getAbsolutePath() + "/GrabacionU4C16.mp3";
    ...
    public void reproducirU4C16 (View view){
    ...
    public void RecorderU4C17 (View view){
        if (grabacion7 == null) {
            archivoSalida7 = getExternalFilesDir(null).getAbsolutePath() + "/GrabacionU4C17.mp3";
    ...
    public void reproducirU4C17 (View view){
    ...
    public void RecorderU4C18 (View view){
        if (grabacion8 == null) {
            archivoSalida8 = getExternalFilesDir(null).getAbsolutePath() + "/GrabacionU4C18.mp3";
    ...
    public void reproducirU4C18 (View view){
    ...
    public void RecorderU4C19 (View view){
        if (grabacion9 == null) {
            archivoSalida9 = getExternalFilesDir(null).getAbsolutePath() + "/GrabacionU4C19.mp3";
    ...
    public void reproducirU4C19 (View view){
    ...
    public void RecorderU4C110 (View view){
        if (grabacion10 == null) {
            archivoSalida10 = getExternalFilesDir(null).getAbsolutePath() + "/GrabacionU4C110.mp3";
    ...
    public void reproducirU4C110 (View view){
    ...
    public void RecorderU4C111 (View view){
        if (grabacion11 == null) {
            archivoSalida11 = getExternalFilesDir(null).getAbsolutePath() + "/GrabacionU4C111.mp3";
    ...
    public void reproducirU4C111 (View view){
    ...
    public void RecorderU4C112 (View view){
        if (grabacion12 == null) {
            archivoSalida12 = getExternalFilesDir(null).getAbsolutePath() + "/GrabacionU4C112.mp3";
    ...
    public void reproducirU4C112 (View view){
