...
public class U4C3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_u4_c3);

        b1 = (Button) findViewById(R.id.btn_repoU4C31);
        b2 = (Button) findViewById(R.id.btn_repoU4C32);
        b3 = (Button) findViewById(R.id.btn_repoU4C33);
        b4 = (Button) findViewById(R.id.btn_repoU4C34);
        b5 = (Button) findViewById(R.id.btn_repoU4C35);
        b6 = (Button) findViewById(R.id.btn_repoU4C36);
        b7 = (Button) findViewById(R.id.btn_repoU4C37);
        b8 = (Button) findViewById(R.id.btn_repoU4C38);
        b9 = (Button) findViewById(R.id.btn_repoU4C39);
        b10 = (Button) findViewById(R.id.btn_repoU4C310);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), U4C2.class));
                finish();
            }
        });
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(U4C3.this, U5C1.class);
        ...
        btn_recorder = (Button) findViewById(R.id.btn_recU4C31);

        btn_recorder2 = (Button) findViewById(R.id.btn_recU4C32);

        btn_recorder3 = (Button) findViewById(R.id.btn_recU4C33);

        btn_recorder4 = (Button) findViewById(R.id.btn_recU4C34);

        btn_recorder5 = (Button) findViewById(R.id.btn_recU4C35);

        btn_recorder6 = (Button) findViewById(R.id.btn_recU4C36);

        btn_recorder7 = (Button) findViewById(R.id.btn_recU4C37);

        btn_recorder8 = (Button) findViewById(R.id.btn_recU4C38);

        btn_recorder9 = (Button) findViewById(R.id.btn_recU4C39);

        btn_recorder10 = (Button) findViewById(R.id.btn_recU4C310);
        ...
        if (ContextCompat.checkSelfPermission(
            ...
            ActivityCompat.requestPermissions(U4C3.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.RECORD_AUDIO}, 1000);
        }
    }

    public void RecorderU4C31(View view) {
        if (grabacion == null) {
            archivoSalida = getExternalFilesDir(null).getAbsolutePath() + "/GrabacionU4C31.mp3";
    ...
    public void reproducirU4C31(View view) {
    ...
    public void RecorderU4C32(View view) {
        if (grabacion2 == null) {
            archivoSalida2 = getExternalFilesDir(null).getAbsolutePath() + "/GrabacionU4C32.mp3";
    ...
    public void reproducirU4C32(View view) {
    ...
    public void RecorderU4C33(View view) {
        if (grabacion3 == null) {
            archivoSalida3 = getExternalFilesDir(null).getAbsolutePath() + "/GrabacionU4C33.mp3";
    ...
    public void reproducirU4C33(View view) {
    ...
    public void RecorderU4C34(View view) {
        if (grabacion4 == null) {
            archivoSalida4 = getExternalFilesDir(null).getAbsolutePath() + "/GrabacionU4C34.mp3";
    ...
    public void reproducirU4C34(View view) {
    ...
    public void RecorderU4C35(View view) {
        if (grabacion5 == null) {
            archivoSalida5 = getExternalFilesDir(null).getAbsolutePath() + "/GrabacionU4C35.mp3";
    ...
    public void reproducirU4C35(View view) {
    ...
    public void RecorderU4C36(View view) {
        if (grabacion6 == null) {
            archivoSalida6 = getExternalFilesDir(null).getAbsolutePath() + "/GrabacionU4C36.mp3";
    ...
    public void reproducirU4C36(View view) {
    ...
    public void RecorderU4C37(View view) {
        if (grabacion7 == null) {
            archivoSalida7 = getExternalFilesDir(null).getAbsolutePath() + "/GrabacionU4C37.mp3";
    ...
    public void reproducirU4C37(View view) {
    ...
    public void RecorderU4C38(View view) {
        if (grabacion8 == null) {
            archivoSalida8 = getExternalFilesDir(null).getAbsolutePath() + "/GrabacionU4C38.mp3";
    ...
    public void reproducirU4C38(View view) {
    ...
    public void RecorderU4C39(View view) {
        if (grabacion9 == null) {
            archivoSalida9 = getExternalFilesDir(null).getAbsolutePath() + "/GrabacionU4C39.mp3";
    ...
    public void reproducirU4C39(View view) {
    ...
    public void RecorderU4C310(View view) {
        if (grabacion10 == null) {
            archivoSalida10 = getExternalFilesDir(null).getAbsolutePath() + "/GrabacionU4C310.mp3";
    ...
    public void reproducirU4C310(View view) {
