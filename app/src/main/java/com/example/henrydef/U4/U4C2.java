...
public class U4C2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_u4_c2);

        b1 =  findViewById(R.id.btn_repoU4C21);
        b2 =  findViewById(R.id.btn_repoU4C22);
        b3 =  findViewById(R.id.btn_repoU4C23);
        b4 =  findViewById(R.id.btn_repoU4C24);
        b5 =  findViewById(R.id.btn_repoU4C25);
        b6 =  findViewById(R.id.btn_repoU4C26);
        b7 =  findViewById(R.id.btn_repoU4C27);
        b8 =  findViewById(R.id.btn_repoU4C28);
        b9 =  findViewById(R.id.btn_repoU4C29);
        b10 =  findViewById(R.id.btn_repoU4C210);
        next =  findViewById(R.id.nextconver1);

        mp1 = MediaPlayer.create(this, R.raw.u421);
        mp2 = MediaPlayer.create(this, R.raw.u422);
        mp3 = MediaPlayer.create(this, R.raw.u423);
        mp4 = MediaPlayer.create(this, R.raw.u424);
        mp5 = MediaPlayer.create(this, R.raw.u425);
        mp6 = MediaPlayer.create(this, R.raw.u426);
        mp7 = MediaPlayer.create(this, R.raw.u427);
        mp8 = MediaPlayer.create(this, R.raw.u428);
        mp9 = MediaPlayer.create(this, R.raw.u429);
        mp10 = MediaPlayer.create(this, R.raw.u421);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), U4C1.class));
                finish();
            }
        });
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(U4C2.this, U4C3.class);
        ...
        btn_recorder = (Button) findViewById(R.id.btn_recU4C21);

        btn_recorder2 = (Button) findViewById(R.id.btn_recU4C22);

        btn_recorder3 = (Button) findViewById(R.id.btn_recU4C23);

        btn_recorder4 = (Button) findViewById(R.id.btn_recU4C24);

        btn_recorder5 = (Button) findViewById(R.id.btn_recU4C25);

        btn_recorder6 = (Button) findViewById(R.id.btn_recU4C26);

        btn_recorder7 = (Button) findViewById(R.id.btn_recU4C27);

        btn_recorder8 = (Button) findViewById(R.id.btn_recU4C28);

        btn_recorder9 = (Button) findViewById(R.id.btn_recU4C29);

        btn_recorder10 = (Button) findViewById(R.id.btn_recU4C210);
        ...
        if (ContextCompat.checkSelfPermission(
            ...
            ActivityCompat.requestPermissions(U4C2.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.RECORD_AUDIO}, 1000);
        }
    }

    public void RecorderU4C21(View view) {
        if (grabacion == null) {
            archivoSalida = getExternalFilesDir(null).getAbsolutePath() + "/GrabacionU4C21.mp3";
    ...
    public void reproducirU4C21(View view) {
    ...
    public void RecorderU4C22(View view) {
        if (grabacion2 == null) {
            archivoSalida2 = getExternalFilesDir(null).getAbsolutePath() + "/GrabacionU4C22.mp3";
    ...
    public void reproducirU4C22(View view) {
    ...
    public void RecorderU4C23(View view) {
        if (grabacion3 == null) {
            archivoSalida3 = getExternalFilesDir(null).getAbsolutePath() + "/GrabacionU4C23.mp3";
    ...
    public void reproducirU4C23(View view) {
    ...
    public void RecorderU4C24(View view) {
        if (grabacion4 == null) {
            archivoSalida4 = getExternalFilesDir(null).getAbsolutePath() + "/GrabacionU4C24.mp3";
    ...
    public void reproducirU4C24(View view) {
    ...
    public void RecorderU4C25(View view) {
        if (grabacion5 == null) {
            archivoSalida5 = getExternalFilesDir(null).getAbsolutePath() + "/GrabacionU4C25.mp3";
    ...
    public void reproducirU4C25(View view) {
    ...
    public void RecorderU4C26(View view) {
        if (grabacion6 == null) {
            archivoSalida6 = getExternalFilesDir(null).getAbsolutePath() + "/GrabacionU4C26.mp3";
    ...
    public void reproducirU4C26(View view) {
    ...
    public void RecorderU4C27(View view) {
        if (grabacion7 == null) {
            archivoSalida7 = getExternalFilesDir(null).getAbsolutePath() + "/GrabacionU4C27.mp3";
    ...
    public void reproducirU4C27(View view) {
    ...
    public void RecorderU4C28(View view) {
        if (grabacion8 == null) {
            archivoSalida8 = getExternalFilesDir(null).getAbsolutePath() + "/GrabacionU4C28.mp3";
    ...
    public void reproducirU4C28(View view) {
    ...
    public void RecorderU4C29(View view) {
        if (grabacion9 == null) {
            archivoSalida9 = getExternalFilesDir(null).getAbsolutePath() + "/GrabacionU4C29.mp3";
    ...
    public void reproducirU4C29(View view) {
    ...
    public void RecorderU4C210(View view) {
        if (grabacion10 == null) {
            archivoSalida10 = getExternalFilesDir(null).getAbsolutePath() + "/GrabacionU4C210.mp3";
    ...
    public void reproducirU4C210(View view) {
