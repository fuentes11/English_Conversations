...
public class U5C2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_u5_c2);

        b1 = (Button) findViewById(R.id.btn_repoU5C21);
        b2 = (Button) findViewById(R.id.btn_repoU5C22);
        b3 = (Button) findViewById(R.id.btn_repoU5C23);
        b4 = (Button) findViewById(R.id.btn_repoU5C24);
        b5 = (Button) findViewById(R.id.btn_repoU5C25);
        b6 = (Button) findViewById(R.id.btn_repoU5C26);
        b7 = (Button) findViewById(R.id.btn_repoU5C27);
        b8 = (Button) findViewById(R.id.btn_repoU5C28);
        next = (Button) findViewById(R.id.nextconver1);

        mp1 = MediaPlayer.create(this, R.raw.u5c21);
        mp2 = MediaPlayer.create(this, R.raw.u5c22);
        mp3 = MediaPlayer.create(this, R.raw.u5c23);
        mp4 = MediaPlayer.create(this, R.raw.u5c24);
        mp5 = MediaPlayer.create(this, R.raw.u5c25);
        mp6 = MediaPlayer.create(this, R.raw.u5c26);
        mp7 = MediaPlayer.create(this, R.raw.u5c27);
        mp8 = MediaPlayer.create(this, R.raw.u5c28);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(), U5C1.class));
                finish();
            }
        });
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(U5C2.this, U5C3.class);
        ...
        btn_recorder = (Button) findViewById(R.id.btn_recU5C21);

        btn_recorder2 = (Button) findViewById(R.id.btn_recU5C22);

        btn_recorder3 = (Button) findViewById(R.id.btn_recU5C23);

        btn_recorder4 = (Button) findViewById(R.id.btn_recU5C24);

        btn_recorder5 = (Button) findViewById(R.id.btn_recU5C25);

        btn_recorder6 = (Button) findViewById(R.id.btn_recU5C26);

        btn_recorder7 = (Button) findViewById(R.id.btn_recU5C27);

        btn_recorder8 = (Button) findViewById(R.id.btn_recU5C28);
        ...
        if (ContextCompat.checkSelfPermission(
            ...
            ActivityCompat.requestPermissions(U5C2.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.RECORD_AUDIO}, 1000);
        }
    }

    public void RecorderU5C21(View view) {
        if (grabacion == null) {
            archivoSalida = getExternalFilesDir(null).getAbsolutePath() + "/GrabacionU5C21.mp3";
    ...
    public void reproducirU5C21(View view) {
    ...
    public void RecorderU5C22(View view) {
        if (grabacion2 == null) {
            archivoSalida2 = getExternalFilesDir(null).getAbsolutePath() + "/GrabacionU5C22.mp3";
    ...
    public void reproducirU5C22(View view) {
    ...
    public void RecorderU5C23(View view) {
        if (grabacion3 == null) {
            archivoSalida3 = getExternalFilesDir(null).getAbsolutePath() + "/GrabacionU5C23.mp3";
    ...
    public void reproducirU5C23(View view) {
    ...
    public void RecorderU5C24(View view) {
        if (grabacion4 == null) {
            archivoSalida4 = getExternalFilesDir(null).getAbsolutePath() + "/GrabacionU5C24.mp3";
    ...
    public void reproducirU5C24(View view) {
    ...
    public void RecorderU5C25(View view) {
        if (grabacion5 == null) {
            archivoSalida5 = getExternalFilesDir(null).getAbsolutePath() + "/GrabacionU5C25.mp3";
    ...
    public void reproducirU5C25(View view) {
    ...
    public void RecorderU5C26(View view) {
        if (grabacion6 == null) {
            archivoSalida6 = getExternalFilesDir(null).getAbsolutePath() + "/GrabacionU5C26.mp3";
    ...
    public void reproducirU5C26(View view) {
    ...
    public void RecorderU5C27(View view) {
        if (grabacion7 == null) {
            archivoSalida7 = getExternalFilesDir(null).getAbsolutePath() + "/GrabacionU5C27.mp3";
    ...
    public void reproducirU5C27(View view) {
    ...
    public void RecorderU5C28(View view) {
        if (grabacion8 == null) {
            archivoSalida8 = getExternalFilesDir(null).getAbsolutePath() + "/GrabacionU5C28.mp3";
    ...
    public void reproducirU5C28(View view) {
